...
<Project Type="Project" LVVersion="20008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Modules" Type="Folder">
			<Item Name="Contabilidad.lvlib" Type="Library" URL="../Libraries/Contabilidad/Contabilidad.lvlib"/>
			<Item Name="Dinero.lvlib" Type="Library" URL="../Libraries/Dinero/Dinero.lvlib"/>
			<Item Name="Hardware.lvlib" Type="Library" URL="../Libraries/Hardware/Hardware.lvlib"/>
			<Item Name="Manejador Turnos.lvlib" Type="Library" URL="../Libraries/Manejador Turnos/Manejador Turnos.lvlib"/>
			<Item Name="Paquetes Disponibles.lvlib" Type="Library" URL="../Libraries/Paquetes Disponibles/Paquetes Disponibles.lvlib"/>
			<Item Name="UI.lvlib" Type="Library" URL="../Libraries/UI/UI.lvlib"/>
		</Item>
		<Item Name="Testers" Type="Folder">
			<Item Name="Test Contabilidad API.vi" Type="VI" URL="../Libraries/Contabilidad/Test Contabilidad API.vi"/>
			<Item Name="Test Dinero API.vi" Type="VI" URL="../Libraries/Dinero/Test Dinero API.vi"/>
			<Item Name="Test Hardware API.vi" Type="VI" URL="../Libraries/Hardware/Test Hardware API.vi"/>
			<Item Name="Test Manejador Turnos API.vi" Type="VI" URL="../Libraries/Manejador Turnos/Test Manejador Turnos API.vi"/>
			<Item Name="Test Paquetes Disponibles API.vi" Type="VI" URL="../Libraries/Paquetes Disponibles/Test Paquetes Disponibles API.vi"/>
			<Item Name="Test UI API.vi" Type="VI" URL="../Libraries/UI/Test UI API.vi"/>
		</Item>
		<Item Name="Unit Test" Type="Folder">
			<Item Name="Unit Testing.lvclass" Type="LVClass" URL="../Libraries/Unit Test/Unit Testing/Unit Testing.lvclass"/>
		</Item>
