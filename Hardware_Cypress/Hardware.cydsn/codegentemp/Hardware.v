// ======================================================================
// Hardware.v generated from TopDesign.cysch
// 11/29/2021 at 15:16
...
module top ;
	...
	wire [7:0] tmpOE__Barra_net;
	wire [7:0] tmpFB_7__Barra_net;
	wire [7:0] tmpIO_7__Barra_net;
	wire [0:0] tmpINTERRUPT_0__Barra_net;
	electrical [0:0] tmpSIOVREF__Barra_net;
	...
	cy_psoc3_pins_v1_10
		...
		Barra
		 (.oe(tmpOE__Barra_net),
		  .y({Net_1[7:0]}),
		  .fb({tmpFB_7__Barra_net[7:0]}),
		  .io({tmpIO_7__Barra_net[7:0]}),
		  .siovref(tmpSIOVREF__Barra_net),
		  .interrupt({tmpINTERRUPT_0__Barra_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Barra_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{8'b11111111} : {8'b11111111};
    ...
    UART_v2_50_0 Serial (
        ...
        .tx_en(Net_23),
        .tx_interrupt(Net_24));
    defparam Serial.Address1 = 0;
    defparam Serial.Address2 = 0;
    defparam Serial.EnIntRXInterrupt = 0;
    defparam Serial.EnIntTXInterrupt = 0;
    defparam Serial.FlowControl = 0;
    defparam Serial.HalfDuplexEn = 0;
    defparam Serial.HwTXEnSignal = 1;
    defparam Serial.NumDataBits = 8;
    defparam Serial.NumStopBits = 1;
    defparam Serial.ParityType = 0;
    defparam Serial.RXEnable = 1;
    defparam Serial.TXEnable = 1;
